    ...
    def scan_ports(self):
        ...
        for port in com_ports:
            ...
            try:
                ...
                if  "MMC-200" in self_id:
                    port_found = True
                    print "Config: Found: " + port + ": MMC-200"
                    self.setup_mmc100_port(port)
...
##
        ...
        ##factory
        ##vel= 2.0, MPL=0, EPL=0
        ##HCG=0, TLP=999.0 TLN =-999.0
        self.send_commnd(ser,'1VEL2.0\r');
        self.send_commnd(ser,'1MPL1\r') 
        self.send_commnd(ser,'1EPL1\r')
        self.send_commnd(ser,'1LDR1\r')
        self.send_commnd(ser,'1FBK2\r')
        self.send_commnd(ser,'1HCG0\r')
        self.send_commnd(ser,'1TLP5.0\r')
        self.send_commnd(ser,'1TLN-5.0\r')

        ##x-axis, 2
        ##factory
        ##vel= 2.0, MPL=0, EPL=0
        ##HCG=0, TLP=999.0 TLN =-999.0
        self.send_commnd(ser,'2VEL5.0\r');
        self.send_commnd(ser,'2MPL1\r') 
        self.send_commnd(ser,'2EPL1\r')
        self.send_commnd(ser,'2LDR1\r')
        self.send_commnd(ser,'2FBK2\r')
        self.send_commnd(ser,'2HCG1\r')
        self.send_commnd(ser,'2TLP12.5\r')
        self.send_commnd(ser,'2TLN-12.5\r')
        
        ##y-axis, 3
        ##factory
        ##vel= 2.0, MPL=0, EPL=0
        ##HCG=0, TLP=999.0 TLN =-999.0
        self.send_commnd(ser,'3VEL5.0\r');
        self.send_commnd(ser,'3MPL1\r') 
        self.send_commnd(ser,'3EPL1\r')
        self.send_commnd(ser,'3LDR1\r')
        self.send_commnd(ser,'3FBK2\r')
        self.send_commnd(ser,'3HCG1\r')
        self.send_commnd(ser,'3TLP25.0\r')
        self.send_commnd(ser,'3TLN-25.0\r')

        if 0:
            self.send_commnd(ser,'3MPL0\r') 
            self.send_commnd(ser,'3EPL0\r')
            self.send_commnd(ser,'3HCG0\r')
##
